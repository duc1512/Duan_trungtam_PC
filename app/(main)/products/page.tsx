...
const allProducts = [
  ...
  {
    id: "gpu-001",
    name: "Card màn hình ASUS Dual RTX 4060",
    price: 8290000,
  ...
  {
    id: "monitor-001",
    name: "Màn hình LG UltraGear 24GN65R-B 144Hz",
    price: 3590000,
  ...
  {
    id: "keyboard-001",
    name: "Bàn phím cơ DareU EK87 White/Black",
    price: 450000,
  ...
  {
    id: "ssd-001",
    name: "SSD WD Blue SN580 1TB NVMe",
    price: 1790000,
  ...
  {
    id: "psu-001",
    name: "Nguồn Corsair RM850e 850W 80+ Gold",
    price: 2890000,
          ...
          {sortedProducts.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] bg-gray-100">
                <Image
                  src={imgErrors[product.id] ? "/placeholder-product.png" : product.image}
                  alt={product.name}
                  fill
