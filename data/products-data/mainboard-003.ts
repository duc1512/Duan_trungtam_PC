...
export const mainboard003: Product = {
  id: "mainboard-003",
  name: "Gigabyte X670E AORUS Master DDR5",
  brand: "Gigabyte",
  price: 11990000,
  ...
  specifications: [
    ...
    { label: "Audio", value: "ESS SABRE HiFi 9118" },
  ],
  stock: 15,
  sku: "X670E-AORUS-MASTER",
  warranty: "48 tháng chính hãng Gigabyte",
  features: [
    "Mainboard X670E cao cấp",
    "PCIe 5.0 cả GPU và M.2",
    "DDR5-8000 XMP/EXPO",
    "10GbE + WiFi 6E",
    "VRM 16+2+2 105A",
    "Bảo hành 4 năm",
